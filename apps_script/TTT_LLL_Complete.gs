/**
 * ═══════════════════════════════════════════════════════════════════
 *  TTT-LLL — COMPLETE APPS SCRIPT.  One file. Paste ALL of it.
 * ═══════════════════════════════════════════════════════════════════
 *
 *  This replaces every earlier file. Do not keep Code.gs,
 *  config_addition.gs and drive_addition.gs alongside it — this IS all
 *  three, with the two routing edits already in place. Pasting the
 *  pieces separately is what left the Drive functions unreachable last
